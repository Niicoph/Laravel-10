    ...
    <x-card class="mb-4 text-sm">
        ...
        <div class="mb-4 grid grid-cols-2 gap-4">
          <div>
            ...
            <x-text-input name="search" value="" placeholder="Search for any text" form-id="filtering-form" />
          </div>
          <div>
        ...
        <button class="btn w-full border p-2 rounded-md font-bold ">Filter</button>
